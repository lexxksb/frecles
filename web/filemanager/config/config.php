...
$upload_dir = '/upload/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../upload/source/'; // relative path from filemanager folder to upload folder (with final /)
...
$access_keys = array("LTP-1094Q-9B");
